...
public class TryPeriodAndDuration {
    public void periodAndDuration() {
        ...
        Period periodBetween = Period.between(LocalDate.of(2021, 06, 30), LocalDate.of(2022, 10, 15));
        Period periodChrono = Period.from(ChronoPeriod.between(LocalDate.of(2021, 12, 30), LocalDate.of(2022, 10, 15)));

        long chronoDays = ChronoUnit.DAYS.between(LocalDate.of(2021, 06, 30), LocalDate.of(2022, 10, 15));
        ...
        LocalDateTime localDateTime = LocalDateTime.of(2021, 10, 12, 12, 0, 0);
